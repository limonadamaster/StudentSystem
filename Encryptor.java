...
public class Encryptor {
    public String encryptString(String inputPassword) throws NoSuchAlgorithmException {
    ...
    public  boolean checkPassword(String inputPassword, String storedHashedPassword) throws NoSuchAlgorithmException {
